...
refúgio aconchegante. Está localizado no alto da montanha, com o privilégio de uma vista exuberante
para o mar e algumas ilhas da região. Isolado do sistema urbano, em meio a natureza preservada do sul da
Ilha de Florianópolis, o Aruna foi no passado um Eco Spa, após uma grande reforma, mudamos a
proposta para locações pontuais de algumas unidades.</span></p>
        ...
        <span className={classes.description}>A suíte Sabiá é muito bem ventilada, e iluminada, possui uma cama de casal e uma cozinha equipada para
fazer suas refeições, além do banheiro com box e uma varanda que é compartilhada com a suíte Tucano.
Nossa água vem da nascente, estamos rodeados pela floresta preservada e praticamente sem vizinhos
próximos.<br></br><br></br>
